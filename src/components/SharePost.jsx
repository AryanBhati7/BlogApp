...
function SharePost({ openBtnClasses, closeBtnClasses, postLink, postTitle }) {
  ...
  return (
    <div className="flex justify-end">
      ...
      >
        {/* //   <!-- CONTAINER MODAL--> */}
        {/* <div className="min-h-screen overflow-hidden overflow-y-hidden bg-transparent flex items-center justify-center"> */}
        {/* <!--MODAL ITEM--> */}
        <div class=" w-full mx-4 p-4 rounded-xl md:w-1/2 lg:w-1/3 text-gray-800 dark:text-neutral-200 dark:bg-dark-bg bg-gray-200 border border-gray-200">
          {/* <!--MODAL HEADER--> */}
          <div class="flex justify-between items center border-b border-gray-200 py-3">
            <div class="flex items-center justify-center ">
              <p class="text-xl font-bold text-gray-800 dark:text-neutral-50">
                Share this Post
              </p>
            </div>
            ...
            <div
              itemType="button"
              onClick={closeModal}
              class="bg-gray-300  text-xl hover:bg-gray-500 cursor-pointer hover:text-gray-300 dark:hover:text-gray-100 font-sans text-black w-8 h-8 flex items-center justify-center rounded-full"
            >
              X
            </div>
          </div>
          ...
          <div class="my-4">
            ...
            <div class="flex justify-around my-4">
              ...
              <RedditShareButton url={postLink} title={postTitle}>
                <div class="border hover:bg-orange-50 w-12 h-12 fill-[#bc2a8d] hover:fill-white border-pink-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-orange-300 cursor-pointer">
